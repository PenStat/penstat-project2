import{r as e,p as t}from"./c97e7166.js";import{S as i}from"./35d82fc1.js";const r=new URL(new URL("2a3c155e.svg",import.meta.url).href,import.meta.url).href,n=new URL(new URL("247d7fcf.svg",import.meta.url).href,import.meta.url).href,a=new URL(new URL("f1d14e54.svg",import.meta.url).href,import.meta.url).href;class c extends i{static get tag(){return"card-icon"}constructor(){super(),this.icon=n,this.type="objective",this.alt="Question Mark Icon"}static get properties(){return{...super.properties,icon:{type:String},type:{type:String},alt:{type:String}}}updated(e){super.updated(e),e.forEach(((e,t)=>{"type"===t&&"science"===this[t]&&(this.icon=r,this.alt="A lab beaker icon"),"type"===t&&"objective"===this[t]&&(this.icon=n,this.alt="A lightbulb icon"),"type"===t&&"question"===this[t]&&(this.icon=a,this.alt="Question Mark Icon")}))}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e)}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}static get styles(){return[...super.styles,e`
        :host {
          display: block;
