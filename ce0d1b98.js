import{r as e,y as t}from"./8d82d9f9.js";import{S as r}from"./936f9985.js";const i=new URL(new URL("f5b82f72.svg",import.meta.url).href,import.meta.url).href,n=new URL(new URL("c68b41a8.svg",import.meta.url).href,import.meta.url).href,c=new URL(new URL("f1d14e54.svg",import.meta.url).href,import.meta.url).href;class o extends r{static get tag(){return"card-icon"}constructor(){super(),this.icon=n,this.type="objective"}static get properties(){return{...super.properties,icon:{type:String},type:{type:String}}}updated(e){super.updated(e),e.forEach(((e,t)=>{"type"===t&&"science"===this[t]&&(this.icon=i,this.accentColor="green"),"type"===t&&"objective"===this[t]&&(this.icon=n),"type"===t&&"question"===this[t]&&(this.icon=c)}))}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e)}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}static get styles(){return[...super.styles,e`
        :host {
          display: block;
